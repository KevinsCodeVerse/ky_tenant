<template>
	<el-header>
        ...
        <div class="header_bottom" :style="getWidth()">
          <div
              style="display: flex;width: 50px;align-items: center;justify-content: center;font-size: 12px;gap: 5px;color: #409EFF;cursor: pointer;" @click="$router.go(-1)">
...
<script>
	export default {
        ...
        name:sessionStorage.getItem("userName")===undefined?'':sessionStorage.getItem("userName"),
				collapse: false,
				breadcrumbs: [],
                tabs: [],
                tabsValue: '',
