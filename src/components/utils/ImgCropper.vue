...
<template>
	<div id="imgCropper">
		<el-dialog title="图片裁剪" :visible.sync="isshow" width="700px" center  append-to-body :close-on-click-modal="false" @close="close">
			<div class="cropper-content">
				<div class="cropper-box">
					...
					<div class="footer-btn">
						<label class="btn" @click="$refs.uploads.click()">选择图片</label>
						<input type="file" ref="uploads" style="position: absolute; clip: rect(0 0 0 0)" accept="image/png, image/jpeg, image/gif, image/jpg" @change="selectImg($event)" />
						<el-button size="mini" type="danger" plain icon="el-icon-zoom-in" @click="changeScale(0.2)">放大</el-button>
						<el-button size="mini" type="danger" plain icon="el-icon-zoom-out" @click="changeScale(-0.2)">缩小</el-button>
